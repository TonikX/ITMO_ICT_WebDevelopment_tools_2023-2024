...
Revision ID: e339e44273b0
Revises: 
Create Date: 2024-04-03 17:10:51.209936
...
def upgrade() -> None:
    ...
    sa.Column('genre', sa.Enum('Fiction', 'NonFiction', 'Mystery', 'Romance', 'ScienceFiction', name='bookgenres'), nullable=True),
    sa.Column('bio', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
