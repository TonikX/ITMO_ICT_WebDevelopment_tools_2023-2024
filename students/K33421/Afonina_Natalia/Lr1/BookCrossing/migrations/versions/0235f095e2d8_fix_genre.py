...
Revision ID: 0235f095e2d8
Revises: 7a135b497a8d
Create Date: 2024-04-01 22:05:41.221401
...
revision: str = '0235f095e2d8'
down_revision: Union[str, None] = '7a135b497a8d'
...
def upgrade() -> None:
    ...
    sa.Column('genre', sa.Enum('Fiction', 'NonFiction', 'Mystery', 'Romance', 'ScienceFiction', name='bookgenre'), nullable=True),
    sa.Column('bio', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
