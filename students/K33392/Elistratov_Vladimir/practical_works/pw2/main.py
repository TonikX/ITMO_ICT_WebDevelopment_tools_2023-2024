...
def warrior_adv_skill(row: SkillWarriorLink, session=Depends(get_session)) -> TypedDict('Response', {"status": int, "data": SkillWarriorLink}):
...
@app.post("/profession")
def profession_create(prof: Profession, session=Depends(get_session)) -> TypedDict('Response', {"status": int,
                                                                                                "data": Profession}):
